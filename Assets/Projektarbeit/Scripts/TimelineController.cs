...
public class TimelineController : MonoBehaviour
{
    ...
    {
        //string pName = currentNode.name;
        //if (currentNode.content == null || currentCategoryIndex >= currentNode.content.Length)
        //{
        //    panoramaSphereController.SetApperance(pName, null);
        //    return;
        //}

        //if (!string.IsNullOrEmpty(currentNode.content[currentCategoryIndex].texture)) pName = currentNode.content[currentCategoryIndex].texture;
        //panoramaSphereController.SetApperance(pName, currentNode.content[currentCategoryIndex]);
    }
